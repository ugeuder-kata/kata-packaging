...
Source0: apache-solr-3.6.0.tgz
Requires: tomcat6
Requires: java-1.6.0-openjdk

%description
SOLR binary package, for version 3.6.0. Installs to a tomcat6 installation as war file and example data files.
...
mv $RPM_BUILD_DIR/apache-solr-3.6.0/example/solr $RPM_BUILD_ROOT/opt
mv $RPM_BUILD_DIR/apache-solr-3.6.0/dist/apache-solr-3.6.0.war $RPM_BUILD_ROOT/opt/solr/solr.war
